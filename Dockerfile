...
RUN curl --silent -o miniconda-installer.sh https://repo.continuum.io/miniconda/Miniconda3-3.16.0-Linux-x86_64.sh && bash miniconda-installer.sh -b -p $HOME/anaconda3
